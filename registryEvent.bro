...
event sysmon_registryEvent(computerName: string,eventType: string, utcTime: string, processGuid: string, processId: string, image: string, targetObject: string, creationUtcTime: string, details: string, newName: string)
{
